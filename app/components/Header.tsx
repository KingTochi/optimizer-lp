...
export default function Header() {
  return (
    <header className="flex flex-col xs:flex-row justify-between items-center w-full mt-3 border-b pb-5 sm:px-4 px-2 border-gray-500 gap-2">
      ...
      <a
        className="flex max-w-fit items-center justify-center space-x-2 rounded-full border border-[#4900E5] text-white px-5 py-2 text-sm shadow-md hover:bg-[#671EFF] bg-[#4900E5] font-medium transition"
